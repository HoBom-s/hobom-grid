...
[@hobom-grid/core](../globals.md) / CellVM
...
Defined in: [viewmodel/view-model.ts:7](https://github.com/HoBom-s/hobom-grid/blob/main/packages/core/src/viewmodel/view-model.ts#L7)
